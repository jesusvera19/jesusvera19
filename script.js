...
let banderas = ["pa.svg", "bo.svg", "ad.svg", "gb.svg", "na.svg", "aus.png", "ecu.png"];

//arreglo que guardara la opcion correcta
let correcta = [2, 2, 1, 1, 0, 0, 1];
...
opciones.push(["AUSTRALIA", "OMAN", "ETIOPIA"]);
opciones.push(["PERU", "ECUADOR", "ETIOPIA"]);
...
//INICIAL SONIDO
let soundWin = new Audio('./audio/win.wav');
let soundLose = new Audio('./audio/lose.wav');
let soundTotal = new Audio('./audio/totalScore.wav');
...
function comprobarRespuesta(opElegida) {
    if (opElegida == correcta[posActual]) {//acertó
        //SE AGREGARA LA FUNCION PARA LA REPRODUCCION DEL SONIDO
        soundWin.play();
